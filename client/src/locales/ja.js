export default {
  ...
  restocking: {
    title: '再入荷',
    description: '需要予測に基づいて在庫補充注文を自動推奨・送信',
    budget: '利用可能予算',
    budgetUsed: '使用済み',
    itemsSelected: '品目選択済み',
    recommendations: '再入荷推奨品',
    noRecommendations: '在庫に一致する需要増加品目が見つかりません。',
    placeOrder: '再入荷注文を発注',
    orderSuccess: '注文が送信されました。14日以内に配達予定です。',
    dismiss: '閉じる',
    table: {
      select: '選択',
      sku: 'SKU',
